...
public:
    ...
    void delCell(std::string cellStr);
    void delAllCell();
    void eraseAllCell();
    Cell *findCell(Cell *cell);
    Cell *findCell(std::string cellStr);
    void replaceCell(Cell* srcCell, Cell *dstCell);
    void replaceCell(std::string srcCellStr, std::string dstCellStr);
